...
from cli_zoho.crm.settings import SettingsClient
...
@click.option("--quiet", is_flag=True, help="Suppress non-data output")
@click.pass_context
def pipelines_create(ctx, data, json_mode, quiet):
...
@click.option("--quiet", is_flag=True, help="Suppress non-data output")
@click.pass_context
def pipelines_update(ctx, pipeline_id, data, json_mode, quiet):
...
@click.option("--quiet", is_flag=True, help="Suppress non-data output")
@click.pass_context
def variables_create(ctx, data, json_mode, quiet):
...
@click.option("--quiet", is_flag=True, help="Suppress non-data output")
@click.pass_context
def variables_update(ctx, variable_id, data, json_mode, quiet):
...
@click.option("--quiet", is_flag=True, help="Suppress non-data output")
@click.pass_context
def variables_delete(ctx, variable_id, json_mode, quiet):
...
@click.option("--quiet", is_flag=True, help="Suppress non-data output")
@click.pass_context
def update_business_hours(ctx, data, json_mode, quiet):
...
@click.option("--quiet", is_flag=True, help="Suppress non-data output")
@click.pass_context
def update_fiscal_year(ctx, data, json_mode, quiet):
...
@click.option("--quiet", is_flag=True, help="Suppress non-data output")
@click.pass_context
def enable_multi_currency(ctx, data, json_mode, quiet):
